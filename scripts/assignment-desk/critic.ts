...
5. If the format is one that promises full-league coverage (power_rankings, tiers, rookie_draft_grades, matchup_preview, matchup_recap, all_play_record, luck_index, playoff_odds, faab_audit, activity_index, or points_left_on_bench), does the draft actually cover every team (all 12) or every matchup (all 6, for a matchup format)? A themed narrative that only name-checks 3-4 teams and skips the rest fails this format's basic premise → "revise", and say explicitly which teams/matchups are missing.
